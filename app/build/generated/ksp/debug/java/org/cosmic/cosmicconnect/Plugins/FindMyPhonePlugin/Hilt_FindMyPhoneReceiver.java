...
public abstract class Hilt_FindMyPhoneReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((FindMyPhoneReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectFindMyPhoneReceiver(UnsafeCasts.<FindMyPhoneReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
