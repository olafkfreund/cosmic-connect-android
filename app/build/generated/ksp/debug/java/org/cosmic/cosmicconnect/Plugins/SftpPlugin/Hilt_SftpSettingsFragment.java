...
public abstract class Hilt_SftpSettingsFragment extends PluginSettingsFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SftpSettingsFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectSftpSettingsFragment(UnsafeCasts.<SftpSettingsFragment>unsafeCast(this));
    }
  }
}
