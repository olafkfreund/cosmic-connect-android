  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ShareBroadcastReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectShareBroadcastReceiver(UnsafeCasts.<ShareBroadcastReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
