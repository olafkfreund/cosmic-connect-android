...
public abstract class Hilt_PluginSettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PluginSettingsFragment_GeneratedInjector) this.generatedComponent()).injectPluginSettingsFragment(UnsafeCasts.<PluginSettingsFragment>unsafeCast(this));
    }
  }
