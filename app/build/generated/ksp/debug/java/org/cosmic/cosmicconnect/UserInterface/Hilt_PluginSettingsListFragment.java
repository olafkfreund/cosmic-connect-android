...
public abstract class Hilt_PluginSettingsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PluginSettingsListFragment() {
    super();
  }

  Hilt_PluginSettingsListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PluginSettingsListFragment_GeneratedInjector) this.generatedComponent()).injectPluginSettingsListFragment(UnsafeCasts.<PluginSettingsListFragment>unsafeCast(this));
    }
  }
