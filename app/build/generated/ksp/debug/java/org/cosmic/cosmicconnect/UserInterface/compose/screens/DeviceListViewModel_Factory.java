...
public final class DeviceListViewModel_Factory implements Factory<DeviceListViewModel> {
  ...
  public DeviceListViewModel_Factory(Provider<Context> contextProvider,
  ...
  public static DeviceListViewModel_Factory create(Provider<Context> contextProvider,
      Provider<DeviceRegistry> deviceRegistryProvider) {
    return new DeviceListViewModel_Factory(contextProvider, deviceRegistryProvider);
  }

  public static DeviceListViewModel newInstance(Context context, DeviceRegistry deviceRegistry) {
    return new DeviceListViewModel(context, deviceRegistry);
  }
}
