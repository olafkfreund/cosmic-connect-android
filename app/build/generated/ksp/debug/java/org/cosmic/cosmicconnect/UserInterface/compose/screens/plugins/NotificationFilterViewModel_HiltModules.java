...
@OriginatingElement(
    topLevelClass = NotificationFilterViewModel.class
)
public final class NotificationFilterViewModel_HiltModules {
  ...
  public abstract static class BindsModule {
    ...
    @Binds
    @IntoMap
    @LazyClassKey(NotificationFilterViewModel.class)
    @HiltViewModelMap
    public abstract ViewModel binds(NotificationFilterViewModel vm);
  }
