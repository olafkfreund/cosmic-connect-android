...
public abstract class Hilt_DeviceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeviceFragment_GeneratedInjector) this.generatedComponent()).injectDeviceFragment(UnsafeCasts.<DeviceFragment>unsafeCast(this));
    }
  }
