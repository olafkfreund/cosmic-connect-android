package org.cosmicext.connect.integration
...
import org.cosmicext.connect.Plugins.BatteryPlugin.BatteryPlugin
...
class PluginsIntegrationTest {
  ...
  private lateinit var cosmicConnect: CosmicExtConnect
  ...
  fun setup() {
    ...
    // Initialize CosmicExtConnect
    cosmicConnect = CosmicExtConnect.getInstance()
    ...
    val prefs = org.cosmicext.connect.Helpers.TrustedDevices.getDeviceSettings(context, deviceId)
    ...
    assertTrue("Should be in Requested state", TestUtils.waitFor { 
        pairedDevice.pairStatus == org.cosmicext.connect.PairingHandler.PairState.Requested 
    })
