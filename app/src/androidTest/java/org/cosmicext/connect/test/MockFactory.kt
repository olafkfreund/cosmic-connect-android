...
object MockFactory {
  ...
  fun createMockLink(
      ...
      deviceType: org.cosmicext.connect.DeviceType = org.cosmicext.connect.DeviceType.DESKTOP
  ): BaseLink {
   ...
   *
   * Note: Creating actual Device objects requires CosmicExtConnect instance
