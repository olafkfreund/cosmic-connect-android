...
class PluginManager private constructor(
    private val manager: uniffi.cosmic_connect_core.PluginManager
) {
    ...
    companion object {
         ...
         * @throws CosmicConnectException if creation fails
         */
        fun create(): PluginManager {
            return try {
                ...
                throw CosmicConnectException("Failed to create plugin manager: ${e.message}", e)
            }
        }
    }
     ...
     * @throws CosmicConnectException if registration fails
     */
    fun registerPlugin(pluginName: String) {
        try {
            ...
            throw CosmicConnectException("Failed to register plugin '$pluginName': ${e.message}", e)
        }
    }
     ...
     * @throws CosmicConnectException if unregistration fails
     */
    fun unregisterPlugin(pluginName: String) {
        try {
            ...
            throw CosmicConnectException("Failed to unregister plugin '$pluginName': ${e.message}", e)
        }
    }
     ...
     * @throws CosmicConnectException if routing fails
     */
    fun routePacket(packet: NetworkPacket) {
        try {
            ...
            throw CosmicConnectException("Failed to route packet: ${e.message}", e)
        }
    }
     ...
     *
     * @throws CosmicConnectException if shutdown fails
     */
    fun shutdownAll() {
        try {
            ...
            throw CosmicConnectException("Failed to shutdown plugins: ${e.message}", e)
        }
    }
     ...
     * @throws CosmicConnectException if update fails
     */
    fun updateBattery(state: BatteryState) {
        try {
            ...
            throw CosmicConnectException("Failed to update battery: ${e.message}", e)
        }
    }
     ...
     * @throws CosmicConnectException if ping creation fails
     */
    fun createPing(message: String? = null): NetworkPacket {
        return try {
            ...
            throw CosmicConnectException("Failed to create ping: ${e.message}", e)
        }
    }
