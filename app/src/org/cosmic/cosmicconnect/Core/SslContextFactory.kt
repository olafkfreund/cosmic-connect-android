...
class SslContextFactory(
    ...
    fun createSslSocket(
        ...
        try {
            ...
            throw CosmicConnectException("Failed to create SSL socket: ${e.message}", e)
        }
    }
    ...
    fun getLocalCertificateFingerprint(): String {
        val localDeviceId = org.cosmic.cosmicconnect.Helpers.DeviceHelper.getDeviceId(context)
