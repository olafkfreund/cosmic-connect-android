...
import org.cosmic.cosmicconnect.databinding.ActivityDigitizerBinding
...
class DigitizerActivity : BaseActivity<ActivityDigitizerBinding>(), DrawingPadView.EventListener {
    ...
    private val plugin: DigitizerPlugin?
        get() {
            val plugin = CosmicConnect.getInstance().getDevicePlugin(deviceId, DigitizerPlugin::class.java)
