...
import org.cosmic.cosmicconnect.databinding.ActivityFindMyPhoneBinding;
...
public class FindMyPhoneActivity extends BaseActivity<ActivityFindMyPhoneBinding> {
    ...
    protected void onStart() {
        super.onStart();
        FindMyPhonePlugin plugin = CosmicConnect.getInstance().getDevicePlugin(deviceId, FindMyPhonePlugin.class);
        if (plugin == null) {
            return;
        }
        plugin.startPlaying();
