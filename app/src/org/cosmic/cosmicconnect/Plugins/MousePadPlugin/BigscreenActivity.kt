...
import org.cosmic.cosmicconnect.databinding.ActivityBigscreenBinding
...
class BigscreenActivity : BaseActivity<ActivityBigscreenBinding>() {
    ...
    private val speechLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        if (result.resultCode == RESULT_OK) {
            ...
            val firstResult = data?.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS)?.firstOrNull()
            if (firstResult != null) {
