...
import org.cosmic.cosmicconnect.Device.PluginsChangedListener
...
import org.cosmic.cosmicconnect.databinding.ActivityDeviceBinding
...
class DeviceFragment : BaseFragment<ActivityDeviceBinding>() {
    ...
    private val device by lazy { CosmicConnect.getInstance().getDevice(deviceId) }
            ...
            PairingHandler.PairState.Paired -> {
                ...
                if (device.isReachable) {
                    ...
                    binding.deviceViewCompose.apply {
                        ...
                        setContent { CosmicTheme(context) { PluginList(pluginsWithButtons, pluginsNeedPermissions, pluginsNeedOptionalPermissions) } }
                    }
