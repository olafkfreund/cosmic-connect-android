...
import org.cosmicext.connect.Backends.BluetoothBackend.BluetoothLinkProvider
import org.cosmicext.connect.Backends.LanBackend.LanLinkProvider
import org.cosmicext.connect.Core.DeviceRegistry
import org.cosmicext.connect.Helpers.NotificationHelper
import org.cosmicext.connect.Plugins.ClipboardPlugin.ClipboardFloatingActivity
import org.cosmicext.connect.Plugins.RunCommandPlugin.RunCommandActivity
import org.cosmicext.connect.Plugins.RunCommandPlugin.RunCommandPlugin
import org.cosmicext.connect.Plugins.SharePlugin.SendFileActivity
 ...
 * It can be started by the CosmicExtConnectBroadcastReceiver on some events or when the MainActivity is launched.
 */
@AndroidEntryPoint
class BackgroundService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d("CosmicExtConnect/BgService", "onCreate")
        instance = this
        ...
        registerReceiver(CosmicExtConnectBroadcastReceiver(), filter)
    ...
    override fun onDestroy() {
        Log.d("CosmicExtConnect/BgService", "onDestroy")
        initialized = false
        for (linkProvider in linkProviders) {
            linkProvider.onStop()
        }
    ...
    companion object {
        const val LOG_TAG = "COSMIC/BackgroundService"
