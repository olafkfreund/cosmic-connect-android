...
import org.cosmicext.connect.Backends.BaseLink.PacketReceiver
import org.cosmicext.connect.Backends.BaseLinkProvider
import org.cosmicext.connect.Core.TransferPacket
import org.cosmicext.connect.DeviceStats.countReceived
import org.cosmicext.connect.DeviceStats.countSent
...
class ConnectionManager(
    ...
    override fun onPacketReceived(tp: TransferPacket) {
        ...
        if (org.cosmicext.connect.Core.PacketType.PAIR == tp.packet.type) {
