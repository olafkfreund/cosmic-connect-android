...
class AndroidCertificateStorage(private val context: Context) {
    ...
    private fun generateAndStoreLocalCertificate(deviceId: String): Certificate {
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to store certificate: ${e.message}", e)
        }
    }
    ...
    private fun loadLocalCertificate(): Certificate {
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to load local certificate: ${e.message}", e)
        }
    }
    ...
    fun storeDeviceCertificate(deviceId: String, certificate: Certificate) {
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to store device certificate: ${e.message}", e)
        }
    }
    ...
    fun getDeviceCertificate(deviceId: String): Certificate {
        ...
        if (!deviceCertFile.exists()) {
            throw CosmicExtConnectException("Certificate not found for device: $deviceId")
        }
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to load device certificate: ${e.message}", e)
        }
    }
    ...
    private fun extractDeviceIdFromCert(certPem: ByteArray): String {
        ...
        return cnMatch?.groupValues?.get(1) ?: throw CosmicExtConnectException("Could not extract device ID from certificate")
    }
