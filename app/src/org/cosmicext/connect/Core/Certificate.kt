...
data class Certificate(
    ...
    companion object {
         ...
         * @throws CosmicExtConnectException if generation fails
         */
        fun generate(deviceId: String): Certificate {
            try {
                ...
                throw CosmicExtConnectException("Failed to generate certificate: ${e.message}", e)
            }
        }
         ...
         * @throws CosmicExtConnectException if loading fails
         */
        fun load(certPath: String, keyPath: String): Certificate {
            try {
                ...
                throw CosmicExtConnectException("Failed to load certificate: ${e.message}", e)
            }
        }
     ...
     * @throws CosmicExtConnectException if saving fails
     */
    fun save(certPath: String, keyPath: String) {
        try {
            ...
            throw CosmicExtConnectException("Failed to save certificate: ${e.message}", e)
        }
    }
