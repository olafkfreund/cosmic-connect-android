...
class Discovery private constructor(
    private val service: uniffi.cosmic_ext_connect_core.DiscoveryService
) {
    ...
    companion object {
         ...
         * @throws CosmicExtConnectException if discovery fails to start
         */
        fun start(
        ...
        fun start(
            ...
            try {
                ...
                // Create FFI callback
                val callback = object : uniffi.cosmic_ext_connect_core.DiscoveryCallback {
                ...
                throw CosmicExtConnectException("Failed to start discovery: ${e.message}", e)
            }
        }
    }
     ...
     *
     * @throws CosmicExtConnectException if stop fails
     */
    fun stop() {
        try {
            ...
            throw CosmicExtConnectException("Failed to stop discovery: ${e.message}", e)
        }
    }
