...
data class NetworkPacket(
     ...
     * @throws CosmicExtConnectException if serialization fails
     */
    fun serialize(): ByteArray {
        try {
            ...
            throw CosmicExtConnectException("Failed to serialize packet: ${e.message}", e)
        }
    }
    ...
    companion object {
        ...
        fun create(type: String, body: Map<String, Any> = emptyMap()): NetworkPacket {
            ...
            try {
                ...
                throw CosmicExtConnectException("Failed to create packet: ${e.message}", e)
            }
        }
        ...
        fun createWithId(id: Long, type: String, body: Map<String, Any> = emptyMap()): NetworkPacket {
            ...
            try {
                ...
                throw CosmicExtConnectException("Failed to create packet with ID: ${e.message}", e)
            }
        }
         ...
         * @throws CosmicExtConnectException if deserialization fails
         */
        fun deserialize(data: ByteArray): NetworkPacket {
            try {
                ...
                throw CosmicExtConnectException("Failed to deserialize packet: ${e.message}", e)
            }
        }
        ...
        private fun toJsonString(map: Map<String, Any>): String {
            ...
            return try {
                ...
                throw CosmicExtConnectException("Failed to encode body as JSON: ${e.message}", e)
            }
        }
         ...
         *
         * @throws CosmicExtConnectException if JSON is invalid
         */
        ...
        private fun parseJsonString(json: String): Map<String, Any> {
            ...
            return try {
                ...
                throw CosmicExtConnectException("Failed to parse JSON body: $preview", e)
            }
        }
    }
