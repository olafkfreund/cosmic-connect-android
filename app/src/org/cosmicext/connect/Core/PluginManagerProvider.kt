    ...
    fun getInstance(): PluginManager {
        if (instance == null) {
            try {
                ...
                // Ensure CosmicExtConnectCore is initialized
                if (!CosmicExtConnectCore.isReady) {
                    CosmicExtConnectCore.initialize()
                }
                ...
                throw CosmicExtConnectException("Failed to create shared PluginManager: ${e.message}", e)
            }
        }
