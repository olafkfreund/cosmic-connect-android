 ...
 * ```
 *
 * @see org.cosmicext.connect.Plugins.BatteryPlugin.BatteryPlugin
 */
object BatteryPacketsFFI {
    ...
    fun createBatteryPacket(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createBatteryPacket(isCharging, currentCharge, thresholdEvent)
    ...
    fun createBatteryRequest(): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createBatteryRequest()
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
}
