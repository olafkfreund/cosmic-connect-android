...
import org.cosmicext.connect.Core.BatteryState
import org.cosmicext.connect.Core.CosmicExtConnectCore
import org.cosmicext.connect.Core.NetworkPacket
import org.cosmicext.connect.Core.TransferPacket
import org.cosmicext.connect.Core.PluginManager
import org.cosmicext.connect.Core.PluginManagerProvider
...
class BatteryPluginFFI @AssistedInject constructor(
    ...
    companion object {
        ...
        // Threshold events (keep in sync with COSMIC Connect protocol)
