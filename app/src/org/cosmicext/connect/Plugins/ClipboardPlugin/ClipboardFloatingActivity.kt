...
/*
    ...
    adb -d shell pm grant org.cosmicext.connect android.permission.READ_LOGS;
    ...
    adb -d shell appops set org.cosmicext.connect SYSTEM_ALERT_WINDOW allow;
    # Kill the app, new permissions take effect on restart.
    adb -d shell am force-stop org.cosmicext.connect;
