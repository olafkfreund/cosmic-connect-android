...
import uniffi.cosmic_ext_connect_core.createContactsResponseUids
import uniffi.cosmic_ext_connect_core.createContactsResponseVcards
...
object ContactsPacketsFFI {
    ...
    fun createUidsTimestampsResponse(uidsJson: String): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createContactsResponseUids(uidsJson)
    ...
    fun createVCardsResponse(vcardsJson: String): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createContactsResponseVcards(vcardsJson)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
}
