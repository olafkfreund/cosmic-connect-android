...
class MprisReceiverPlayer(val controller: MediaController, val name: String) {
    ...
    var position: Long
        ...
        set(value) {
            controller.transportControls.seekTo(value)
        }
