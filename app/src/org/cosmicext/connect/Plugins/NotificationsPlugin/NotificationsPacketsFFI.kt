 ...
 * ```
 *
 * @see org.cosmicext.connect.Plugins.NotificationsPlugin.NotificationsPlugin
 */
...
object NotificationsPacketsFFI {
    ...
    fun createCancelNotificationPacket(notificationId: String): NetworkPacket {
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createCancelNotificationPacket(notificationId)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createDismissNotificationPacket(notificationId: String): NetworkPacket {
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createDismissNotificationPacket(notificationId)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createNotificationActionPacket(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createNotificationActionPacket(notificationKey, action)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createNotificationReplyPacket(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createNotificationReplyPacket(replyId, message)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
}
