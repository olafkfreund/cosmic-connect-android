...
import org.cosmicext.connect.messaging.MessagingNotificationHandler
import org.cosmicext.connect.Plugins.NotificationsPlugin.extraction.RichTextExtractor
...
import org.cosmicext.connect.Helpers.AppsHelper
...
class NotificationsPlugin @AssistedInject constructor(
    ...
    companion object {
        ...
        private fun getNotificationKeyCompat(statusBarNotification: StatusBarNotification): String {
            ...
            return if (tag != null && tag.startsWith("cosmicextconnectId:")) {
    ...
    private fun sendNotification(statusBarNotification: StatusBarNotification, isPreexisting: Boolean) {
        ...
        if (packageName == "org.cosmicext.connect" || packageName == "org.cosmicext.connect.debug") {
            return
        }
