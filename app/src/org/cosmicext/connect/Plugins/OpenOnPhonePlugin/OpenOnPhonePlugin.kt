...
package org.cosmicext.connect.Plugins.OpenOnPhonePlugin
...
class OpenOnPhonePlugin @AssistedInject constructor(
    ...
    companion object {
         ...
         * Broadcast actions
         */
        const val ACTION_APPROVE_OPEN = "org.cosmicext.connect.Plugins.OpenOnPhonePlugin.APPROVE"
        const val ACTION_REJECT_OPEN = "org.cosmicext.connect.Plugins.OpenOnPhonePlugin.REJECT"
     ...
     */
    private fun handleOpenRequest(np: org.cosmicext.connect.Core.NetworkPacket) {
