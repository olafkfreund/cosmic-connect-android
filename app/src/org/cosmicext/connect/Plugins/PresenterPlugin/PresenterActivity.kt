...
import org.cosmicext.connect.UserInterface.compose.screens.plugins.PresenterScreen
...
class PresenterActivity : ComponentActivity(), SensorEventListener {
    ...
    private val mediaSession by lazy {
        if (offScreenControlsSupported) MediaSessionCompat(this, "cosmicextconnect") else null
    }
