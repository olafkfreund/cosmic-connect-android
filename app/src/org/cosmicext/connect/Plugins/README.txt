Writing a plugin for COSMIC Connect
=================================

For Android (this project):
-----------------------------------------

1. Change directory to src/org/cosmic/cosmicconnect/Plugins.
...
7. Open src/org/cosmic/cosmicconnect/Plugins/PluginFactory.java.
...
8. Open src/org/cosmic/cosmicconnect/NetworkPacket.java. Copy a "public final static String PACKET_TYPE_PING = …" line
...
For the desktop client (project cosmicconnect-kde):
--------------------------------------
...
9. Edit cosmicconnect_findmyphone.desktop file:
  ...
  D. Set X-COSMICConnect-SupportedPacketType and X-COSMICConnect-OutgoingPacketType to the packet type your plugin will receive
     and send, respectively. In this example this is "cosmicconnect.findmyphone". Make sure that this matches what is defined in
