...
import uniffi.cosmic_ext_connect_core.createMousepadEcho
import uniffi.cosmic_ext_connect_core.createMousepadKeyboardstate
...
object RemoteKeyboardPacketsFFI {
    ...
    fun createEchoPacket(bodyJson: String): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createMousepadEcho(bodyJson)
    ...
    fun createKeyboardStatePacket(state: Boolean): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createMousepadKeyboardstate(state)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
}
