...
internal class RunCommandWidgetDataProvider(private val context: Context, val intent: Intent?) : RemoteViewsFactory {
    ...
    override fun onCreate() {
        ...
        if (widgetId == AppWidgetManager.INVALID_APPWIDGET_ID) {
            Log.e("COSMICConnect/Widget", "RunCommandWidgetDataProvider: No widget id extra was set")
            return
        }
    ...
    private fun getPlugin(): RunCommandPlugin? {
        return CosmicExtConnect.getInstance().getDevicePlugin(deviceId, RunCommandPlugin::class.java)
    }
