...
class ScreenShareViewerActivity : ComponentActivity(), SurfaceHolder.Callback {
    ...
    private fun findActiveSession(deviceId: String?): org.cosmicext.connect.Plugins.ScreenSharePlugin.streaming.StreamSession? {
        if (deviceId == null) return null
        val device = CosmicExtConnect.getInstance().getDevice(deviceId) ?: return null
