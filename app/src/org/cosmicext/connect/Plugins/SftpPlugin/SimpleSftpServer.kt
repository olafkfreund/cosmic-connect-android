...
import org.cosmicext.connect.Helpers.SecurityHelpers.constantTimeCompare
import org.cosmicext.connect.Plugins.SftpPlugin.saf.SafFileSystemFactory
import org.cosmicext.connect.Plugins.SftpPlugin.saf.SafPath
...
internal class SimpleSftpServer {
    ...
    companion object {
        ...
        const val USER: String = "cosmicconnect"
