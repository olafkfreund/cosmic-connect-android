...
object SharePacketsFFI {
    ...
    fun createFileShare(
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to create file share packet: ${e.message}", e)
        }
    }
    ...
    fun createTextShare(text: String): NetworkPacket {
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to create text share packet: ${e.message}", e)
        }
    }
    ...
    fun createUrlShare(url: String): NetworkPacket {
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to create URL share packet: ${e.message}", e)
        }
    }
    ...
    fun createMultiFileUpdate(
        ...
        try {
            ...
            throw CosmicExtConnectException("Failed to create multi-file update packet: ${e.message}", e)
        }
    }
}
