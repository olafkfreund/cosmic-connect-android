...
import org.cosmicext.connect.Helpers.FilesHelper
import org.cosmicext.connect.Helpers.IntentHelper
...
import org.cosmicext.connect.async.BackgroundJobHandler
...
class SharePlugin @AssistedInject constructor(
    ...
    private fun createOrUpdateDynamicShortcut(shortcutToUpdate: ShortcutInfoCompat?) {
        ...
        val categories = if (isNewShortcut) {
            setOf("org.cosmicext.connect.category.SHARE_TARGET")
        } else {
    ...
    companion object {
        const val ACTION_CANCEL_SHARE = "org.cosmicext.connect.Plugins.SharePlugin.CancelShare"
