 ...
 * ```
 *
 * @see org.cosmicext.connect.Plugins.TelephonyPlugin.TelephonyPlugin
 */
object TelephonyPacketsFFI {
    ...
    fun createTelephonyEvent(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createTelephonyEvent(event, phoneNumber, contactName)
    ...
    fun createMuteRequest(): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createMuteRequest()
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createSmsMessages(conversationsJson: String): NetworkPacket {
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createSmsMessages(conversationsJson)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createConversationsRequest(): NetworkPacket {
        val ffiPacket = uniffi.cosmic_ext_connect_core.createConversationsRequest()
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createConversationRequest(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createConversationRequest(threadId, startTimestamp, count)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createAttachmentRequest(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createAttachmentRequest(partId, uniqueIdentifier)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
    ...
    fun createSendSmsRequest(
        ...
        val ffiPacket = uniffi.cosmic_ext_connect_core.createSendSmsRequest(phoneNumber, messageBody)
        return NetworkPacket.fromFfiPacket(ffiPacket)
    }
}
