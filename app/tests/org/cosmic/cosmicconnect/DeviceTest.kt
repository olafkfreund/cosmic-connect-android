...
import org.cosmic.cosmicconnect.DeviceInfo.Companion.isValidDeviceId
import org.cosmic.cosmicconnect.DeviceInfo.Companion.isValidIdentityPacket
import org.cosmic.cosmicconnect.DeviceInfo.Companion.loadFromSettings
import org.cosmic.cosmicconnect.DeviceType.Companion.fromString
...
class DeviceTest {
    ...
    fun testDeviceInfoToIdentityPacket() {
        ...
        deviceInfo.incomingCapabilities = hashSetOf("cosmicconnect.plugin1State", "cosmicconnect.plugin2State")
        deviceInfo.outgoingCapabilities = hashSetOf("cosmicconnect.plugin1State.request", "cosmicconnect.plugin2State.request")
