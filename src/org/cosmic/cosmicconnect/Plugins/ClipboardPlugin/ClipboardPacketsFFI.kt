...
/**
 * Java-compatible function to check if packet is a standard clipboard update.
 *
 * Equivalent to the `isClipboardUpdate` extension property.
 *
...
/**
 * Java-compatible function to check if packet is a clipboard connect packet.
 *
 * Equivalent to the `isClipboardConnect` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a clipboard connect packet, false otherwise
 */
...
/**
 * Java-compatible function to extract clipboard content.
 *
 * Equivalent to the `clipboardContent` extension property.
 *
 * @param packet NetworkPacket to extract content from
 * @return Clipboard text content, or null if not available
 */
...
/**
 * Java-compatible function to extract clipboard timestamp.
 *
 * Equivalent to the `clipboardTimestamp` extension property.
 *
 * @param packet NetworkPacket to extract timestamp from
 * @return Timestamp in milliseconds, or null if not available
 */
