...
import org.cosmic.cosmicconnect.databinding.ActivityMousepadBinding;
...
public class MousePadActivity
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        MousePadPlugin plugin = CosmicConnect.getInstance().getDevicePlugin(deviceId, MousePadPlugin.class);
        if (plugin == null) {
            finish();
            return;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        boolean digitizerEnabled =
                CosmicConnect.getInstance().getDevicePlugin(deviceId, DigitizerPlugin.class) != null;
    ...
    private void showCompose() {
        ...
        intent.putExtra("org.cosmic.cosmicconnect.Plugins.MousePadPlugin.deviceId", deviceId);
        startActivity(intent);
    }
