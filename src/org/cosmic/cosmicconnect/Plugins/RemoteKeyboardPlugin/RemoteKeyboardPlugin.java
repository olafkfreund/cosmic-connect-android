...
public class RemoteKeyboardPlugin extends Plugin implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final static String PACKET_TYPE_MOUSEPAD_REQUEST = "cosmicconnect.mousepad.request";
    private final static String PACKET_TYPE_MOUSEPAD_ECHO = "cosmicconnect.mousepad.echo";
    private final static String PACKET_TYPE_MOUSEPAD_KEYBOARDSTATE = "cosmicconnect.mousepad.keyboardstate";
