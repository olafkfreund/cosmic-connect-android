...
class RunCommandWidgetProvider : AppWidgetProvider() {
    ...
    override fun onEnabled(context: Context) {
        ...
        CosmicConnect.getInstance().addDeviceListChangedCallback("RunCommandWidget") {
            forceRefreshWidgets(context)
        }
    }

    override fun onDisabled(context: Context) {
        CosmicConnect.getInstance().removeDeviceListChangedCallback("RunCommandWidget")
...
internal fun updateAppWidget(
    ...
    val device: Device? = if (deviceId != null) CosmicConnect.getInstance().getDevice(deviceId) else null
    ...
    if (device == null) {
        ...
        // 2. the string id does not match any devices in CosmicConnect.getInstance()
