...
/**
 * Java-compatible function to check if packet is a telephony event.
 *
 * Equivalent to the `isTelephonyEvent` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a telephony event, false otherwise
 */
fun getIsTelephonyEvent(packet: NetworkPacket): Boolean {
    return packet.isTelephonyEvent
}

/**
 * Java-compatible function to check if packet is a mute request.
 *
 * Equivalent to the `isMuteRequest` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a mute request, false otherwise
 */
fun getIsMuteRequest(packet: NetworkPacket): Boolean {
    return packet.isMuteRequest
}

/**
 * Java-compatible function to extract telephony event type.
 *
 * Equivalent to the `telephonyEvent` extension property.
 *
 * @param packet NetworkPacket to extract event from
 * @return Event type string, or null if not available
 */
fun getTelephonyEvent(packet: NetworkPacket): String? {
    return packet.telephonyEvent
}

/**
 * Java-compatible function to extract phone number.
 *
 * Equivalent to the `telephonyPhoneNumber` extension property.
 *
 * @param packet NetworkPacket to extract phone number from
 * @return Phone number string, or null if not available
 */
fun getTelephonyPhoneNumber(packet: NetworkPacket): String? {
    return packet.telephonyPhoneNumber
}

/**
 * Java-compatible function to extract contact name.
 *
 * Equivalent to the `telephonyContactName` extension property.
 *
 * @param packet NetworkPacket to extract contact name from
 * @return Contact name string, or null if not available
 */
fun getTelephonyContactName(packet: NetworkPacket): String? {
    return packet.telephonyContactName
}

// SMS

/**
 * Java-compatible function to check if packet is SMS messages.
 *
 * Equivalent to the `isSmsMessages` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is SMS messages, false otherwise
 */
fun getIsSmsMessages(packet: NetworkPacket): Boolean {
    return packet.isSmsMessages
}

/**
 * Java-compatible function to check if packet is a conversations request.
 *
 * Equivalent to the `isConversationsRequest` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a conversations request, false otherwise
 */
fun getIsConversationsRequest(packet: NetworkPacket): Boolean {
    return packet.isConversationsRequest
}

/**
 * Java-compatible function to check if packet is a conversation request.
 *
 * Equivalent to the `isConversationRequest` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a conversation request, false otherwise
 */
fun getIsConversationRequest(packet: NetworkPacket): Boolean {
    return packet.isConversationRequest
}

/**
 * Java-compatible function to check if packet is an attachment request.
 *
 * Equivalent to the `isAttachmentRequest` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is an attachment request, false otherwise
 */
fun getIsAttachmentRequest(packet: NetworkPacket): Boolean {
    return packet.isAttachmentRequest
}

/**
 * Java-compatible function to check if packet is a send SMS request.
 *
 * Equivalent to the `isSendSmsRequest` extension property.
 *
 * @param packet NetworkPacket to check
 * @return true if packet is a send SMS request, false otherwise
 */
fun getIsSendSmsRequest(packet: NetworkPacket): Boolean {
    return packet.isSendSmsRequest
}

/**
 * Java-compatible function to extract thread ID from conversation request.
 *
 * Equivalent to the `smsRequestThreadId` extension property.
 *
 * @param packet NetworkPacket to extract thread ID from
 * @return Thread ID as Long, or null if not available
 */
fun getSmsRequestThreadId(packet: NetworkPacket): Long? {
    return packet.smsRequestThreadId
}

/**
 * Java-compatible function to extract start timestamp from conversation request.
 *
 * Equivalent to the `smsRequestStartTimestamp` extension property.
 *
 * @param packet NetworkPacket to extract timestamp from
 * @return Start timestamp in milliseconds, or null if not available
 */
fun getSmsRequestStartTimestamp(packet: NetworkPacket): Long? {
    return packet.smsRequestStartTimestamp
}

/**
 * Java-compatible function to extract message count from conversation request.
 *
 * Equivalent to the `smsRequestCount` extension property.
 *
 * @param packet NetworkPacket to extract count from
 * @return Maximum message count as Int, or null if not available
 */
fun getSmsRequestCount(packet: NetworkPacket): Int? {
    return packet.smsRequestCount
}

/**
 * Java-compatible function to extract attachment part ID.
 *
 * Equivalent to the `smsAttachmentPartId` extension property.
 *
 * @param packet NetworkPacket to extract part ID from
 * @return Attachment part ID as Long, or null if not available
 */
fun getSmsAttachmentPartId(packet: NetworkPacket): Long? {
    return packet.smsAttachmentPartId
}

/**
 * Java-compatible function to extract attachment unique identifier.
 *
 * Equivalent to the `smsAttachmentUniqueId` extension property.
 *
 * @param packet NetworkPacket to extract unique ID from
 * @return Unique identifier string, or null if not available
 */
fun getSmsAttachmentUniqueId(packet: NetworkPacket): String? {
    return packet.smsAttachmentUniqueId
}

/**
 * Java-compatible function to extract recipient phone number from send SMS request.
 *
 * Equivalent to the `smsRecipientNumber` extension property.
 *
 * @param packet NetworkPacket to extract phone number from
 * @return Recipient phone number string, or null if not available
 */
fun getSmsRecipientNumber(packet: NetworkPacket): String? {
    return packet.smsRecipientNumber
}

/**
 * Java-compatible function to extract message body from send SMS request.
 *
 * Equivalent to the `smsMessageBody` extension property.
 *
 * @param packet NetworkPacket to extract message body from
 * @return Message body text, or null if not available
 */
fun getSmsMessageBody(packet: NetworkPacket): String? {
    return packet.smsMessageBody
}
