...
class MainActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    override fun onStart() {
        ...
        CosmicConnect.getInstance().addDeviceListChangedCallback(this::class.simpleName!!) { runOnUiThread { updateDeviceList() } }
        updateDeviceList()
    ...
    override fun onStop() {
        CosmicConnect.getInstance().removeDeviceListChangedCallback(this::class.simpleName!!)
